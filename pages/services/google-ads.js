...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/google-ads`} meta_description='How to run google ads?' imageUrl='/img/bg10.webp' hideContact={true} pageTitle='Google Ads'>
        <div className='bg-black h-[25vh] p-4 xl:p-8 bg-hero-pattern10  bg-cover bg-center bg-no-repeat'>
            <div className='bg-black/60 rounded-[1px] flex flex-col gap-2 p-3 xl:p-6 items-center  justify-center text-white w-full h-full'>
                ...
                <h2 className='text-h2'>Google Ads</h2>
            </div>
        </div>

        <div className='bg-black flex flex-col items-center text-white px-[5vw]' alt='first'>
          <div className='h-8' alt='spacer'></div>
          <h3 className='text-h3 text-center'>What Are Google Ads?</h3>
          <p className='mt-2 text-center max-w-[500px]'>Google Ads are a premium service that put your website higher in the search results.</p>
            ...
            <div className='bg-[#191919] flex gap-4 flex-col xl:flex-row items-center xl:items-start mt-8 p-4'>
              ...
              <div className='flex overflow-x-scroll flex-col xl:flex-row gap-8' alt='sub holder'>
                ...
                <div className='flex flex-col items-center w-96' alt='subitem'>
                  ...
                  <p className='mt-2'>Now that we have an understanding of what to do, we test effectiveness of the solution. This is a 6 month process of intense A/B testing of different search query strategies.</p>
                </div>
