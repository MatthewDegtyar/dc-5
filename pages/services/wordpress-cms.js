...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/wordpress-cms`} meta_description='WordPress business website' imageUrl='/img/bg5.jpeg' hideContact={true} pageTitle='WordPress CMS'>
        <div className='bg-black h-[25vh] p-4 xl:p-8 bg-hero-pattern5 bg-cover bg-center bg-no-repeat'>
            <div className='bg-black/60 rounded-[1px] flex flex-col gap-2 p-3 xl:p-6 items-center  justify-center text-white w-full h-full'>
                ...
                <h2 className='text-h2'>WordPress CMS</h2>
            </div>
        </div>
        ...
        <h3 className='text-h3 text-center'>Web Design Pricing Schedule (WordPress CMS)</h3>
          ...
          <div className='p-4 bg-[#191919] hover:bg-gradient-to-br from-transparent to-[#282828] items-center flex flex-col xl:items-start' alt='item'>
            ...
            <div className='mt-4'>
              ...
              <div className='flex flex-col gap-1 mt-2'>
                <div className='ml-4'>
                  <li>Website from Scratch</li>
                  <li>WordPress Theme (Compatible With WordPress CMS)</li>
