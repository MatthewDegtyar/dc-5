...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/wordpress-cms`} meta_description='WordPress business website' imageUrl='/img/bg5.webp' hideContact={true} pageTitle='WordPress CMS'>
