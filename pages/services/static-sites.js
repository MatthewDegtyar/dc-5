...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/static-sites`} meta_description='How to make a business website' imageUrl='/img/bg7.webp' hideContact={true} pageTitle='Static Sites'>
