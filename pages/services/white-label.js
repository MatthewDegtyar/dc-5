...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/white-label`} meta_description='White label websites' imageUrl='/img/bg6.webp' hideContact={true} pageTitle='White Label'>
        <div className='bg-black h-[25vh] p-4 xl:p-8 bg-hero-pattern6  bg-cover bg-center bg-no-repeat'>
            <div className='bg-black/60 rounded-[1px] flex flex-col gap-2 p-3 xl:p-6 items-center  justify-center text-white w-full h-full'>
                ...
                <h2 className='text-h2'>White Label Websites & Solutions</h2>
            </div>
        </div>

        <div className='bg-black flex flex-col items-center text-white px-[5vw]' alt='first'>
          <div className='h-8' alt='spacer'></div>
          <h3 className='text-h3 text-center'>What Is White Labeling?</h3>
          <p className='mt-2 text-center max-w-[500px]'>We design and build a digital solution for you (such as a website template), you brand it as yours and add it to your service line.</p>
            ...
            <div className='bg-[#191919] flex gap-4 flex-col xl:flex-row items-center xl:items-start mt-8 p-4'>
              ...
              <div className='flex overflow-x-scroll flex-col xl:flex-row gap-8' alt='sub holder'>
                ...
                <div className='flex flex-col items-center w-96' alt='subitem'>
                  ...
                  <h5 className='mt-4 text-[22px] font-medium'>Product Research</h5>
                  <p className='mt-2'>We'll work closely with you to research 1.  what pain points your clients face, 2. desired outcomes to these pain points, and 3. outline solutions that delivery on those outcomes.</p>
                </div>
                
                <div className='flex flex-col items-center w-96' alt='subitem'>
                  <FaConnectdevelop color='white' size={42}/>
                  <h5 className='mt-4 text-[22px] font-medium'>Development (0 to 1)</h5>
                  <p className='mt-2'>Now that we have an understanding of what to do, we build a demo while incorporating feedback from focus groups about the effectiveness of the solution. This culminates with the presentation of an MVP.</p>
                </div>

                <div className='flex flex-col items-center w-96' alt='subitem'>
                  <IoRocket color='white' size={42}/>
                  <h5 className='mt-4 text-[22px] font-medium'>Optimization (1 to n)</h5>
                  <p className='mt-2'>We optimize inefficiencies, manage feature creep, and prepare the solution to be deployed into full production.</p>
                </div>
