...
const Page = () => {
  ...
  return (
    <RootLayout canon_url={`services/social-media`} meta_description='How to run a social media ccount?' imageUrl='/img/bg12.webp' hideContact={true} pageTitle='Social Media'>
        <div className='bg-black h-[25vh] p-4 xl:p-8 bg-hero-pattern12  bg-cover bg-center bg-no-repeat'>
            <div className='bg-black/60 rounded-[1px] flex flex-col gap-2 p-3 xl:p-6 items-center  justify-center text-white w-full h-full'>
                ...
                <h2 className='text-h2'>Social Media Management</h2>
            </div>
        </div>

        <div className='bg-black flex flex-col items-center text-white px-[5vw]' alt='first'>
          <div className='h-8' alt='spacer'></div>
          <h3 className='text-h3 text-center'>What Is Social Media Management?</h3>
          <p className='mt-2 text-center max-w-[500px]'>We'll take on the work of deploying resources into social media ads as well as manage content and inqueries.</p>
            ...
            <div className='bg-[#191919] flex gap-4 flex-col xl:flex-row items-center xl:items-start mt-8 p-4'>
              ...
              <div className='flex overflow-x-scroll flex-col xl:flex-row gap-8' alt='sub holder'>
                ...
                <div className='flex flex-col items-center w-96' alt='subitem'>
                  ...
                  <p className='mt-2'>Now that we have an understanding of what to do, we test effectiveness of the solution. This is a 4 month process of intense A/B testing of different strategies.</p>
                </div>
          ...
          <div className='mt-4 flex flex-col xl:flex-row gap-8 xl:gap-24 sm:px-[10vw] md:px-[15vw] lg:px-[20vw] xl:px-[0vw] cursor-default' alt='holder'>
            <div className='w-full bg-gradient-to-tr from-blue-500 rounded-[1px] to-violet-500'>
              ...
              <div className='bg-[#191919] hover:scale-[98%] rounded-[1px] transition-all duration-100 w-full h-full p-4'>
                ...
                <div className='mt-6'>
                  ...
                  <br></br>
                  <p>Our applications are built on top of Shopify's Inventory Management System.</p>
                  <br></br>
                  <p>We combine Shopify's easy to use IMS with break-neck speeds to create a world class digital storefront.</p>
                  <br></br>
                  <p>If operate an existing Shopify site we guarantee that you'll see no disruption during the redesign process.</p>
                </div>
              </div>
            ...
            <div className='w-full bg-gradient-to-tr from-blue-500 rounded-[1px] to-violet-500'>
              <div className='bg-[#191919] hover:scale-[98%] transition-all rounded-[1px] duration-100 h-full w-full p-4'>
                ...
                <div className='mt-6'>
                  <p>Shopify's Inventory Mangament System is great. Their hosting isn't.</p>
                  <br></br>
                  ...
                  <br></br>
                  <p>Retain the Shopify IMS you're already familiar with without compromising on performance.</p>
                  <br></br>
                  <p>Pay less for Google Ads. Google determines how much you pay for ads based on a 'trust' score and a speed score. We'll work on optimizng both of rankings for a greater ROAS.</p>
                </div>
              </div>
            </div>
            <div className='w-full bg-gradient-to-tr from-blue-500 rounded-[1px] to-violet-500'>
